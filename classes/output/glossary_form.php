...
/**
 * Autotranslate Glossary Form Output
 *
...
class glossary_form extends \moodleform {
    ...
    public function definition() {
        ...
        // Get the merged records.
        $mergedrecords = [];
        foreach ($sourcerecords as $record) {
            $mergedrecord = $record;
            $targetrecord = $this->findObjectByKeyValue($targetrecords, "hash", $record->hash);
            $mergedrecord->target_text = $targetrecord ? $targetrecord->text : "";
            $mergedrecord->target_lang = $targetrecord ? $targetrecord->lang : $targetlang;

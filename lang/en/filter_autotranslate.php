...
$string['cachedef_modschemas'] = 'Module schemas cache';
$string['cachedef_selectedfields'] = 'Selected fields cache';
$string['cachedef_taggedcontent'] = 'Tagged content cache';
...
$string['privacy:metadata'] = 'The Autotranslate filter processes user-generated content by sending it to external translation services. Translations are stored locally but are not linked to specific user IDs.';
$string['privacy:metadata:translation_api'] = 'User-generated content (such as forum posts, wiki pages, and glossary entries) is sent to an external translation API service for automatic translation.';
$string['privacy:metadata:translation_api:text'] = 'The text content to be translated (may include user-generated content).';
$string['privacy:metadata:translation_api:sourcelanguage'] = 'The source language of the content.';
$string['privacy:metadata:translation_api:targetlanguage'] = 'The target language for translation.';
$string['privacy:metadata:translations'] = 'Translations are stored locally by content hash and are shared across the site when identical content appears. No user IDs are stored.';
$string['privacy:metadata:translations:translated_text'] = 'The translated text content.';
$string['privacy:metadata:translations:lang'] = 'The language code of the translation.';
$string['privacy:metadata:translations:timecreated'] = 'When the translation was created.';
$string['privacy:metadata:translations:timemodified'] = 'When the translation was last modified.';
